public class MyMath 
{
    ...
    public static double makePow(double base, double result)
    {
    	...
    	else if(1/result==round(reverse(result)))
    	{
    		power = makePow(base, 1/result);
    		power = power*-1;
    		
    	}
    	else if(result==round(result) && base==round(base) && result>=base)
    	{
    		power=neededMethods.ln(result)/neededMethods.ln(base);
    ...
    public static class neededMethods
    {
    	...
    	public static double ln2=0.693147181;
