...
import JGJAR.libraries.MyMath.annotations.MayReturnComplex;
...
public class MyMath
{
     ...
     * 
     * @param x number floor of you'll get
    ...
    /**Returns Arithmetic-Geometric Mean
     * 
     * @param a
     * @param b
     * @param itter
    ...
    /**Returns Arithmetic Mean between a and b
     * 
     * @param a
     * @param b
     * @return (a+b)/2
    ...
    /**Returns Arithmetic Weighted Mean
     * 
    ...
    {
    	if(downOrUp==0)
    		return neededMethods.fractionDown(num);
    	else if(downOrUp==1)
    		return neededMethods.fractionUp(num);
    	else
    		return NaN;
    ...
    /*public static int toInversedBooleanArray(int a)
    {
     ...
     * 
     * @param a your number
     * @return how many prime numbers before your number
     * @since 1.2.0
     */
    ...
    public static String nonDecOperations(String num1, String num2, int system, Operation oper)
    {
    	...
    	switch(oper)
    	{
    		...
    		case LN:
    			...
    			break;
    		case TETRATION:
    			decresult = tetration(dec1, dec2);
    			break;
    		case SUPERLOG:
    			decresult = superlog(dec1, dec2);
    			break;
    		case SUPERROOT:
    			decresult = superroot(dec1, dec2);
    			break;
     ...
     * @since 0.9.9.17
     */
    final public static double min_value = max_value*-1-1;;
