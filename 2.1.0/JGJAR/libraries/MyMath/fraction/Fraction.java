...
import JGJAR.libraries.MyMath.MyMath.neededMethods;
import JGJAR.libraries.MyMath.exceptions.FractionFormatException;
...
public class Fraction extends Number
{
	 ...
	 * @param down deninator of fraction
	 */
	...
	*/
	...
	{
		return MyMath.toFraction(MyMath.root(a.doubleValue(), n.doubleValue()));
	...
	{
		return MyMath.toFraction(MyMath.sqrt(a.doubleValue()));
	...
	{
		return MyMath.toFraction(MyMath.cbrt(a.doubleValue()));
	...
	{
		return new Fraction(MyMath.ln(a.num)-MyMath.ln(a.den));
