...
public class Vector 
{
	...
	public final static Vector I = new Vector(1, 0, 0), J = new Vector(0, 1, 0), K = new Vector(0, 0, 1), ZERO = new Vector(0, 0, 0);
	...
	/**Multiplies vectors to tensor
	 * 
	 * @param a first vector
	 * @param b second vector
	 * @return a&otimes;b
	 * @since 1.2 (MyMath 2.1.0)
	 */
	public static Matrix TensorProduct(Vector a, Vector b)
	{
		return Matrix.multiply(a.toMatrix().T(), b.toMatrix());
