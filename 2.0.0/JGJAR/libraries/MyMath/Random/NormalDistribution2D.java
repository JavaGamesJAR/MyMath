...
{
	public NormalDistribution2D(double[] mu, double[] sigma)
	{
		this.m1 = mu[0];
		this.m2 = mu[1];
		this.s1 = sigma[0];
	...
	public Vector2 get()
	{
		NormalDistribution normX = new NormalDistribution(s1, m1);
		NormalDistribution normY = new NormalDistribution(s2, m2);
