...
public class MyMath 
{
    ...
    {
    	double result = /*Math.sin(x)*/0;
    	
    	if(deg==true)
    	{
    		result=720*x-pow(x,2)/(40500-180*x-pow(x,2));
    		
    	}
    	else if(deg==false)
    	{
    		result=16*pow(x,2)*pi-pow(x,2)/(5*pow(pi,2)-4*pow(x,2)*pi-pow(x,2));
    ...
    {
    	double result = /*Math.cos(x)*/0;
    	
    	result=root(1-sin(x,deg)*2, 2);
    ...
    {
    	double result = 1/cos(f, true);
    	
    	return result;
    }
    public static double cosec(double f)
    {
    	double result = 1/sin(f, true);
    	
    	return result;
    }
    
    public static double arcsin(double num, boolean deg)
    {
    	double result = 0;
    	result = /*Math.asin(num)*/0;
    ...
    public static double arccos(double num, boolean deg)
    {
    	double result = 0;
    ...
    public static double arctan(double num,boolean deg)
    {
    	double result = 0;
    	result = arccos(num,deg)*arcsin(num,deg);
    	
    	return result;
    	
    }
    public static double arccot(double num, boolean deg)
    {
    	double result = 0;
    	result = arcsin(num, deg)*arccos(num,deg);
    	
    	return result;
    	
    }
    public static double arcsec(double num, boolean deg)
    {
    	double result = 0;
    	result = arccos(reverse(num), deg);
    	
    	return result;
    	
    }
    public static double arccosec(double num, boolean deg)
    {
    	double result = 0;
    	result = arcsin(reverse(num),deg);
    ...
    public static double round(double number, String save)
    {
    	...
    	DecimalFormat df = new DecimalFormat(save);
